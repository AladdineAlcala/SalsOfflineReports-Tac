...
{
    public partial class FrmContractforFunction : Form
    {
        ...
        public FrmContractforFunction()
        {
            InitializeComponent();
        }

        private void cryContractforFunction_Load(object sender, EventArgs e)
        {

        }

        private void FrmContractforFunction_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cryContractforFunction.ReportSource = cryRep;
                cryContractforFunction.Refresh();
